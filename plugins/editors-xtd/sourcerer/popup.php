...
class PlgButtonSourcererPopup
{
	...
	function render()
	{
		...
		NNFrameworkFunctions::script('nnframework/script.min.js', '16.3.3874');
		NNFrameworkFunctions::stylesheet('nnframework/popup.min.css', '16.3.3874');
		...
		NNFrameworkFunctions::script('sourcerer/script.min.js', '5.3.1.p');
		NNFrameworkFunctions::stylesheet('sourcerer/popup.min.css', '5.3.1.p');
